<div class="modal fade" id="ModalTambahNonPerizinan" tabindex="-1" role="dialog" aria-labelledby="ModalTambahNonPerizinanLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-light">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Non Perizinan</h5>
