        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel-heading">
                    ...
                    <?php endif; ?>
                    <button href="" type="button" class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#ModalTambahBerita"><i class="fa fa-plus fa-fw"></i>Tambah Data</button>
                </div><br>
                <!-- start: Accordion -->
