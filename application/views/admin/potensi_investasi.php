                ...
                <div class="card card-outline card-maroon">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex mb-3">
                            <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#ModalTambahPotensiInvestasi">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($potensi_investasi->result() as $row) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            <button type="button" data-toggle="modal" data-target="#EditPotensiInvestasi<?= $row->id_investasi; ?>" class="btn btn-outline-warning mt-1 mb-1">
                                                <i class="fas fa-edit"></i>
                                            </button>
                                            <button type="button" data-toggle="modal" data-target="#deletePotensiInvestasi<?= $row->id_investasi; ?>" class="btn btn-outline-danger mt-1 mb-1">
...
<?php foreach ($potensi_investasi->result() as $row) : ?>
    <div class="modal fade" id="deletePotensiInvestasi<?= $row->id_investasi; ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?= base_url('admin/potensi_investasi/hapus/' . $row->id_investasi); ?>" class="btn btn-outline-danger">Hapus</a>
                </div>
            </div>
        </div>
    </div>
