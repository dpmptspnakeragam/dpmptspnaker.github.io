<?php foreach ($nonperizinan->result() as $row) : ?>
    <div class="modal fade" id="EditNonPerizinan<?= $row->id_izin; ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <form role="form" action="<?= base_url('admin/nonperizinan/edit'); ?>" method="POST" enctype="multipart/form-data">
