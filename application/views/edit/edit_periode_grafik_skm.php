<?php foreach ($periode_grafik_skm->result() as $row) {
?>
    <div class="modal fade" id="EditPeriodeGrafikSkm<?php echo $row->id_periode; ?>" role="dialog" aria-labelledby="ModalTambahGrafikLabel" aria-hidden="true">
